...
class ResponseTest extends TestCase
{
    ...
    public function test_is_safe_url(): void
    {
        ...
        $this->assertFalse($this->response->isSafeUrl("/path\r\nLocation: http://evil.com"));
        ...
        try {
            ...
            $this->assertFalse($this->response->isSafeUrl('javascript://localhost:8080/%0Aalert(1)'));
            $this->assertFalse($this->response->isSafeUrl('data://localhost:8080/text/html;base64,PHNjcmlwdD5hbGVydCgxKTwvc2NyaXB0Pg=='));
            $this->assertFalse($this->response->isSafeUrl('file://localhost:8080/etc/passwd'));
        } finally {
            if ($oldAppUrl !== '') {
