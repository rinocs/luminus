...
class ResponseTest extends TestCase
{
    ...
    public function test_is_safe_url(): void
    {
        ...
        $this->assertFalse($this->response->isSafeUrl("/\0evil.com"));
        $this->assertFalse($this->response->isSafeUrl('\\evil.com'));
        ...
        try {
            ...
            $this->assertFalse($this->response->isSafeUrl('javascript://localhost:8080/xss'));
            $this->assertFalse($this->response->isSafeUrl('ftp://localhost:8080/home'));
        } finally {
            if ($oldAppUrl !== '') {
